...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250418141826_BodyCompositionLogs")]
    partial class BodyCompositionLogs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.BodyCompositionLogs.BodyCompositionLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasKey("Id")
                        .HasName("pk_body_composition_log");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_body_composition_log_user_id");

                    b.ToTable("body_composition_log", "public");
                });
            ...
            modelBuilder.Entity("Domain.BodyCompositionLogs.BodyCompositionLog", b =>
                {
                    b.HasOne("Domain.Users.User", "User")
                        .WithMany("BodyCompositionLogs")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_body_composition_log_users_user_id");
            ...
            modelBuilder.Entity("Domain.Users.User", b =>
                {
                    b.Navigation("BodyCompositionLogs");
